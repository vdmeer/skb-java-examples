 ...
 * @since      v0.0.7
 */
public class Example_WidthLongestWordMax extends AbstractCommandInterpreter {

	/**
	 * Returns a new interpreter.
	 */
	public Example_WidthLongestWordMax(){
		super(
				SkbShellFactory.newCommand("width-longest-word-max", ShellStatics.WIDTH_COMMANDS, "prints 3 tables with calculated by the longest word in all columns with a maximum column width", null)
		);
	}
